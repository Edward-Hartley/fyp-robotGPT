...
checkpoint_dir = "/home/edward/Imperial/fyp-robotGPT/src/fyp_package/experiments/contact_graspnet/checkpoints/scene_test_2048_bs3_hor_sigma_001"
results_dir = "./assets/"

def grasp_inference(depth, rgb=None, segmap=None, cam_K=config.intrinsics, local_regions=True, skip_border_objects=False, filter_grasps=True, segmap_id=1, z_range=[0.2,1.8], forward_passes=1, results_path='contact_graspnet.npz'):
    ...
    # Save results
    np.savez(os.path.join(results_dir, results_path), 
